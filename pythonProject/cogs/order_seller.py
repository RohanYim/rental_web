...
class Order_seller(commands.Cog):
    def __init__(self, bot):
        self.bot = bot

    @commands.command()
    async def order_seller(self, ctx, bot, start_time, end_time, member: discord.Member = None, *args):
        guild = ctx.guild
        # bot = "Dashe"
        # time = "2021.06.23-2021.06.29"
        title = "New %s Sale!" % bot
